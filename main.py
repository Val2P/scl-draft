...
if __name__ == "__main__":
    ...
    parser.add_argument("--input_graph", "-I", required=True, help="path of input graph")
    parser.add_argument("--database_path", "-D", required=True, help="path to BioGRID database")
    parser.add_argument("--depth_from", "-df", default=0, type=int, help="include starting from to depth n (must be geq than 0)")
